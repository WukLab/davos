#Network
create_ip -name xxv_ethernet -vendor xilinx.com -library ip -module_name ethernet_10g_ip -dir $device_ip_dir
...
#100G
create_ip -name cmac_usplus -vendor xilinx.com -library ip -module_name cmac_usplus_axis -dir $device_ip_dir
